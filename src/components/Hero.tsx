...
export default function Hero() {
  ...
  const benefits = [
    "🔥 STOP MEMBAKAR BAJET IKLAN DENGAN WEBSITE YANG PERLAHAN",
    "⚡ LOADING BAWAH 0.5 SAAT — PELAWAT STAY, PESAING MENANGIS",
    "📈 SETIAP RINGGIT IKLAN BEKERJA 3X LEBIH KERAS",
    "🎯 DESIGN STRATEGIK — BUKAN CANTIK SAHAJA, TAPI MENJUAL",
    "📱 98% VISITOR MOBILE — TUNJUK TAWARAN, BUKAN LOADING SCREEN",
    "🛡️ META PIXEL + GOOGLE ADS TRACKING SIAP — TANPA BAYAR EXTRA",
    "💼 SIAP 72 JAM ATAU REFUND PENUH — TANPA SOAL JAWAB",
  ];
          ...
          >
            ...
            <motion.div variants={badgeVariants} className="flex justify-center lg:justify-start">
              <span className="inline-flex items-center gap-1 text-[9px] sm:text-xs font-mono font-bold tracking-wider sm:tracking-widest uppercase bg-yellow-400/10 text-yellow-300 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full border border-yellow-400/20 shadow-sm shadow-yellow-400/5 select-none whitespace-nowrap">
                ...
                PENUTUP UTAMA KEBOCORAN BAJET IKLAN ANDA
              </span>
            </motion.div>
            ...
            <h1 className="text-[5.8vw] sm:text-3xl md:text-4xl lg:text-[38px] font-black tracking-tight leading-[1.2] lg:leading-[1.1] text-white">
              <span className="inline sm:block overflow-hidden pb-1">
                <motion.span variants={itemVariants} className="inline sm:block">
                  Website Slow Bakar Bajet Iklan:{" "}
                </motion.span>
              </span>
              <span className="inline sm:block overflow-hidden pb-1">
                <motion.span
                ...
                >
                  Upgrade ke sub-0.5s speed,{" "}
                </motion.span>
              </span>
              <span className="inline sm:block overflow-hidden pb-1">
                <motion.span
                  variants={itemVariants}
                  className="bg-gradient-to-r from-amber-300 via-yellow-100 to-amber-400 bg-clip-text text-transparent drop-shadow-[0_2px_20px_rgba(234,179,8,0.3)] inline sm:block mt-1"
                >
                  siap 72 jam.
                </motion.span>
              </span>
            ...
            >
              Setiap saat kelewatan loading, anda kehilangan 7% conversion. Kalau website anda ambil 4 saat nak buka, hampir separuh orang yang klik iklan anda dah lari ke pesaing — sebelum sempat tengok tawaran anda. Kami plug kebocoran itu dalam 72 jam.
            </motion.p>
