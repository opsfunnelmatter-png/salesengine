          ...
          <div className="bg-[#121A2E]/90 border border-white/10 rounded-[28px] p-8 md:p-12 relative overflow-hidden shadow-2xl shadow-black/45 text-center flex flex-col items-center">
            ...
            <div className="max-w-2xl space-y-5 text-slate-300 text-xs sm:text-sm leading-relaxed mb-8">
              ...
              <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-5 text-left space-y-4">
                {[
                  { title: "1. Refund Dalam 3 Hari Bekerja", desc: "Jika kami lewat menghantar draf pertama anda, bayaran anda dikembalikan 100% serta-merta ke akaun asal dalam masa 3 hari bekerja." },
                  { title: "2. Terpakai Untuk Launch & Authority", desc: "Jaminan bertulis ini meliputi Pakej Launch (siap dalam 72 jam bekerja) & Pakej Authority (funnel lengkap siap dalam 5 hari kerja)." },
                  { title: "3. Tiada Syarat Tersembunyi", desc: "Tiada birokrasi, tiada denda pentadbiran, dan tiada terma kecil tersembunyi. Kami telus dan bertanggungjawab sepenuhnya." }
                ].map((point, idx) => (
