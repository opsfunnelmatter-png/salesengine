    ...
    <section className="py-20 border-t border-white/5 bg-transparent relative text-center overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10 space-y-6">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-[38px] font-black text-white tracking-tight leading-tight">
          Setiap Hari Anda Tunggu,{" "}
          <span className="bg-gradient-to-r from-amber-300 via-yellow-100 to-amber-400 bg-clip-text text-transparent drop-shadow-[0_2px_10px_rgba(234,179,8,0.2)] block mt-2">Wang Iklan Anda Terus Terbakar.</span>
        </h2>
        <div className="space-y-3">
          <p className="text-slate-300 max-w-xl mx-auto text-xs sm:text-sm md:text-base leading-relaxed font-medium">
            Anda dah baca sampai sini. Anda tahu website yang laju bukan luxury — ia keperluan untuk iklan yang convert. Satu-satunya langkah yang tinggal adalah ambil tindakan.{" "}
            <strong className="text-white">Isi borang dalam 5 minit. Kami akan hubungi anda secepat mungkin. Draf anda siap dalam 72 jam.</strong>
          </p>
          <p className="text-slate-400 text-xs">
            Atau teruskan dengan website yang sama. Pilihan ada di tangan anda.
          </p>
        </div>
        <div className="pt-2">
          <a
